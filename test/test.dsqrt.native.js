...
var dsqrt = tryRequire( resolve( __dirname, './../lib/dsqrt.native.js' ) );
var opts = {
	'skip': ( dsqrt instanceof Error )
};
...
tape( 'the function has an arity of 5', opts, function test( t ) {
	t.strictEqual( dsqrt.length, 5, 'arity of 5' );
	t.end();
});

tape( 'the function computes the principal square root for each element', opts, function test( t ) {
	var expected;
	var x;
	var y;
	var i;
